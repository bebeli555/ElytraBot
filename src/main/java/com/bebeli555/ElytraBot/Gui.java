...
public class Gui extends GuiScreen{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    	...
    	mc.fontRenderer.drawStringWithShadow(ChatFormatting.RED + "ElytraHighwayBot " + ChatFormatting.GREEN + "V1.6", 1, 1, 0xb8352c);
        ...
        mc.fontRenderer.drawStringWithShadow("Default Value is " + ChatFormatting.GREEN + "1.8", 190, 420, 0xffff);
    }
