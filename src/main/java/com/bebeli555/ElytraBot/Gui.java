...
public class Gui extends GuiScreen{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    	...
    	mc.fontRenderer.drawStringWithShadow(ChatFormatting.RED + "ElytraHighwayBot " + ChatFormatting.GREEN + "V1.9", 1, 1, 0xb8352c);
	...
	public static void TurnOff() {
		Main.delay5 = 0;
		com.bebeli555.ElytraBot.ElytraFly.YCenter = false;
		Main.delay18 = 0;
		Manuver.HasCentered = false;
		com.bebeli555.ElytraBot.ElytraFly.FlyMinus = 0;
