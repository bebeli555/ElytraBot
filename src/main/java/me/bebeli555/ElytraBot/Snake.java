...
public class Snake extends GuiScreen{
	...
	public static void DrawSnake() {
		...
		if (GameOver == true) {
			...
			mc.fontRenderer.drawStringWithShadow(ChatFormatting.AQUA + "Use " + ChatFormatting.GREEN + "ARROW KEYS " + ChatFormatting.AQUA + "To play!", 107, 240, 0xffff);
			GlStateManager.popMatrix();
			return;
		}
	}
	...
	public static void GameOver() {
		if (GameOver == false) {
			...
			AppleY = 0;
			BlockPos Player = new BlockPos(mc.player.posX, mc.player.posY, mc.player.posZ);
			mc.world.playSound(Player, SoundEvents.ENTITY_BAT_DEATH, SoundCategory.AMBIENT, 100.0f, 0.5F, true);
		}
	}
